...
exports.CombatSystem = exports.MovementSystem = exports.System = exports.EntityManager = void 0;
class EntityManager {
    constructor() {
    ...
    getEntitiesWithComponent(componentType) {
        return Array.from(this.entities.values()).filter(entity => entity.components.has(componentType));
    }
}
