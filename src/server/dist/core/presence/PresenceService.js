...
class PresenceService {
     ...
     */
    async heartbeat() {
        if (!this.canWrite() || this.localOnline.size === 0)
            return;
        try {
