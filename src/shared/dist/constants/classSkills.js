...
exports.JOB_TO_CLASS_SKILLS_INDEX = exports.CLASS_SPECIFIC_SKILLS = void 0;
exports.getClassSpecificSkillsForJob = getClassSpecificSkillsForJob;
const skills_1 = require("../types/skills");
...
const SKILLS = {
    "Provoke": {
        ...
        skillType: skills_1.SkillType.PROVOKE,
    },
    "Brewer (Passive)": {
        reqLevel: 12,
        mpCost: 0,
        ...
        skillType: skills_1.SkillType.PASSIVE,
    },
    Lunge: {
        reqLevel: 15,
        mpCost: 25,
        ...
        skillType: skills_1.SkillType.BUFF,
    },
    "Empower (Passive)": {
        reqLevel: 18,
        mpCost: 0,
    ...
    "Leg Sweep": {
        ...
        skillType: skills_1.SkillType.DAMAGE_PHYSICAL,
        onHitEffects: [{ type: status_1.StatusEffectType.SLOW, duration: 5 }],
    },
    "Obscene Gesture": {
        reqLevel: 20,
        mpCost: 0,
    ...
    Hide: {
        ...
        skillType: skills_1.SkillType.UTILITY,
    ...
    "Fire Bolt": {
        ...
        skillType: skills_1.SkillType.DAMAGE_MAGICAL,
    },
    Shock: {
        reqLevel: 12,
        mpCost: 44,
        ...
        skillType: skills_1.SkillType.DAMAGE_MAGICAL,
        onHitEffects: [{ type: status_1.StatusEffectType.KNOCKDOWN }],
    },
    "Scholar (Passive)": {
        reqLevel: 20,
        mpCost: 0,
    ...
    Heal: {
        ...
        skillType: skills_1.SkillType.HEAL,
        healing: { type: "single" },
    },
    "Tranquil Mind": {
        reqLevel: 20,
    ...
    "Divine Aid": {
        ...
        skillType: skills_1.SkillType.HP_BUFF,
    },
    "Thunder Crash": {
        reqLevel: 28,
        mpCost: 32,
    ...
    "Mana Restore": {
        ...
        skillType: skills_1.SkillType.MP_RESTORE,
    },
    "Speedy Gale": {
        reqLevel: 28,
        mpCost: 55,
    ...
    Revive: {
        ...
        skillType: skills_1.SkillType.REVIVE,
    ...
    "Kindling Arrow": {
        ...
        skillType: skills_1.SkillType.FIELD_SPELL,
    },
    "Watchful Eye": {
        reqLevel: 45,
        mpCost: 44,
    ...
    Sanctuary: {
        ...
        skillType: skills_1.SkillType.PARTY_HEAL,
        healing: { type: "party" },
    },
    ...
    "Paralyzing Bond": {
        ...
        skillType: skills_1.SkillType.DEBUFF,
        onHitEffects: [{ type: status_1.StatusEffectType.ROOT, duration: 10 }],
    },
    "Mana Swap": {
        reqLevel: 45,
        mpCost: 16,
...
for (const [idxStr, names] of Object.entries(JOB_SKILL_NAMES)) {
    ...
    for (const name of names) {
        ...
        if (override) {
            job[name] = { ...base, ...override };
        }
        else {
            job[name] = base;
        }
    }
    exports.CLASS_SPECIFIC_SKILLS[idx] = job;
}
const BASE_CLASS_OFFSETS = {
    [jobs_1.BaseClass.WARRIOR]: 0,
    [jobs_1.BaseClass.SCOUT]: 7,
    [jobs_1.BaseClass.ACOLYTE]: 14,
    [jobs_1.BaseClass.MAGE]: 21,
};
exports.JOB_TO_CLASS_SKILLS_INDEX = {
    warrior: 0,
    gladiator: 1,
    juggernaut: 2,
    dragoon: 3,
...
function getClassSpecificSkillsForJob(jobId, baseClass) {
    const index = exports.JOB_TO_CLASS_SKILLS_INDEX[jobId];
    if (index !== undefined && exports.CLASS_SPECIFIC_SKILLS[index]) {
        return exports.CLASS_SPECIFIC_SKILLS[index];
    }
    const offset = BASE_CLASS_OFFSETS[baseClass];
    if (offset !== undefined && exports.CLASS_SPECIFIC_SKILLS[offset]) {
        return exports.CLASS_SPECIFIC_SKILLS[offset];
    }
    return {};
}
