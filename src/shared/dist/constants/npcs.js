...
exports.NPC_DATABASE = void 0;
exports.getNPC = getNPC;
exports.getNPCsInZone = getNPCsInZone;
const npc_1 = require("../types/npc");
const recipes_1 = require("../types/recipes");
exports.NPC_DATABASE = {
    'elder_miriam': {
        id: 'elder_miriam',
        name: 'Elder Miriam',
        type: npc_1.NPCType.QUEST_GIVER,
        modelFile: 'Witch.glb',
    ...
    'varik_blacksmith': craftNpc('varik_blacksmith', 'Borin Ironhand', 'varik_confederation', recipes_1.CraftProfession.BLACKSMITH, { x: -10, y: 0, z: 5 }),
    'varik_alchemist': craftNpc('varik_alchemist', 'Maven Frostbloom', 'varik_confederation', recipes_1.CraftProfession.ALCHEMIST, { x: 10, y: 0, z: 5 }),
    'varik_enchanter': craftNpc('varik_enchanter', 'Aldric rune-Hand', 'varik_confederation', recipes_1.CraftProfession.ENCHANTER, { x: 0, y: 0, z: 15 }),
    'pfelstein_blacksmith': craftNpc('pfelstein_blacksmith', 'Sir Roland the Smith', 'kingdom_pfelstein', recipes_1.CraftProfession.BLACKSMITH, { x: -10, y: 0, z: 5 }),
    'pfelstein_alchemist': craftNpc('pfelstein_alchemist', 'Sister Beatrix', 'kingdom_pfelstein', recipes_1.CraftProfession.ALCHEMIST, { x: 10, y: 0, z: 5 }),
    'pfelstein_enchanter': craftNpc('pfelstein_enchanter', 'Father Cassian', 'kingdom_pfelstein', recipes_1.CraftProfession.ENCHANTER, { x: 0, y: 0, z: 15 }),
    'latugan_blacksmith': craftNpc('latugan_blacksmith', 'Hassan Scorpionsbane', 'latugan_empire', recipes_1.CraftProfession.BLACKSMITH, { x: -10, y: 0, z: 5 }),
    'latugan_alchemist': craftNpc('latugan_alchemist', 'Zahra the Herbalist', 'latugan_empire', recipes_1.CraftProfession.ALCHEMIST, { x: 10, y: 0, z: 5 }),
    'latugan_enchanter': craftNpc('latugan_enchanter', 'Khalid gem-Etcher', 'latugan_empire', recipes_1.CraftProfession.ENCHANTER, { x: 0, y: 0, z: 15 }),
};
function craftNpc(id, name, zoneId, profession, position) {
    const professionLabel = profession === recipes_1.CraftProfession.BLACKSMITH
        ? 'weapons and armor'
        : profession === recipes_1.CraftProfession.ALCHEMIST
            ? 'potions and brews'
            : 'gems and enchantments';
    return {
        id,
        name,
        type: npc_1.NPCType.CRAFTSMAN,
        modelFile: 'Casual Character.glb',
        position,
        rotation: 0,
        zoneId,
...
function getNPC(id) {
    return exports.NPC_DATABASE[id];
}
function getNPCsInZone(zoneId) {
    return Object.values(exports.NPC_DATABASE).filter(npc => npc.zoneId === zoneId);
}
