...
exports.QUEST_DATABASE = {
    ...
    'scout_meadow': {
        ...
        type: quests_1.QuestType.EXPLORE,
        objectives: [
            {
    ...
    'wolf_threat': {
        ...
        objectives: [
            ...
            {
                id: 'collect_pelts',
                type: quests_1.QuestType.COLLECT,
                targetId: 'wolf_pelt',
...
function getQuest(id) {
    return exports.QUEST_DATABASE[id];
}
