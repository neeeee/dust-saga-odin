...
exports.RECIPE_DATABASE = void 0;
exports.getRecipe = getRecipe;
exports.getRecipesByProfession = getRecipesByProfession;
...
exports.RECIPE_DATABASE = {
    ...
    recipe_leather_armor: {
        ...
        resultQuantity: 1,
        profession: recipes_1.CraftProfession.BLACKSMITH,
        requiredLevel: 1,
    ...
    recipe_fire_magic_gem: {
        ...
        resultQuantity: 1,
        profession: recipes_1.CraftProfession.ENCHANTER,
        requiredLevel: 3,
        materials: [
            { itemId: 'fire_gem', quantity: 1 },
...
function getRecipe(id) {
    return exports.RECIPE_DATABASE[id];
}
function getRecipesByProfession(profession) {
    return Object.values(exports.RECIPE_DATABASE).filter(r => r.profession === profession);
}
function getAllRecipes() {
    return Object.values(exports.RECIPE_DATABASE);
}
