...
exports.CATEGORY_LEVEL_SKILLS = exports.CATEGORY_DISPLAY_NAMES = exports.CATEGORY_ID_TO_KEY = exports.CLASS_SKILL_DATA = exports.SKILL_CATEGORIES = exports.DEFAULT_AOE_RADIUS = exports.GROUND_TARGETED_AOE_SKILLS = void 0;
exports.findSkillDefinition = findSkillDefinition;
const skills_1 = require("../types/skills");
const items_1 = require("../types/items");
exports.GROUND_TARGETED_AOE_SKILLS = new Set([
    "Firestorm",
    "Ice Storm",
    "Thunderstorm",
    "Meteor Storm",
        ...
        skills: [
            {
                ...
                skills: {
                    Slice: {
                        ...
                        damageType: skills_1.DamageType.PHYSICAL,
                        damageSubType: skills_1.PhysicalDamageSubType.SLASH,
                        basePower: 1,
                        baseHits: 2,
                    },
                    "Whirling Strike": {
                        ...
                        isAOE: true,
                        aoeRadius: 1,
                        aoeTargetMode: skills_1.AOETargetMode.SELF_CENTERED,
                        knockback: 2,
                    },
                    Parry: {
                        name: "Parry",
            ...
            },
            {
                ...
                skills: {
                    Heave: {
                        ...
                        damageType: skills_1.DamageType.PHYSICAL,
                        damageSubType: skills_1.PhysicalDamageSubType.THRUST,
                        basePower: 1,
                        isAOE: true,
                    },
                    "Triple Stab": {
            ...
            },
            {
                ...
                skills: {
                    Clobber: {
                        ...
                        damageType: skills_1.DamageType.PHYSICAL,
                        damageSubType: skills_1.PhysicalDamageSubType.CLEAVE,
                        basePower: 1,
                    },
                    Riposte: {
                        name: "Riposte",
            ...
            },
            {
                ...
                skills: {
                    Stun: {
                        ...
                        damageType: skills_1.DamageType.PHYSICAL,
                        damageSubType: skills_1.PhysicalDamageSubType.BASH,
                        basePower: 1,
                        hasDebuff: true,
                        debuffEffectTable: {
                            debuffCategory: 'stun',
        ...
        skills: [
            {
                ...
                skills: {
                    "Flaming Arrow": {
                        ...
                        damageType: skills_1.DamageType.PHYSICAL,
                        damageSubType: skills_1.MagicalDamageSubType.FIRE,
                        basePower: 1,
                        elementalPower: 1,
                        hasDebuff: true,
                        requiredWeaponType: [items_1.WeaponType.BOW, items_1.WeaponType.CROSSBOW],
                    },
                    "Cobra Arrow": {
                        name: "Cobra Arrow",
                        reqPoints: 12,
                    ...
                    "Arrow Rain": {
                        ...
                        basePower: 1,
                        isAOE: true,
                        aoeTargetMode: skills_1.AOETargetMode.TARGET_CENTERED,
                        aoeRadius: 5,
                        pulseCount: 3,
                        pulseInterval: 1000,
                        requiredWeaponType: [items_1.WeaponType.BOW],
                    },
                    "Multi Shot": {
                        name: "Multi Shot",
                        reqPoints: [
                        ...
                        damageType: skills_1.DamageType.PHYSICAL,
                        basePower: 1,
                        requiredWeaponType: [items_1.WeaponType.CROSSBOW],
                    },
                    "Charge Shot": {
                        name: "Charge Shot",
                        reqPoints: [
                    ...
                    "Pinning Arrow": {
                        ...
                        damageType: skills_1.DamageType.PHYSICAL,
                        damageSubType: skills_1.PhysicalDamageSubType.RANGED,
                        requiredWeaponType: [items_1.WeaponType.BOW, items_1.WeaponType.CROSSBOW],
                    },
                    "Piercing Shot": {
                        name: "Piercing Shot",
            ...
            },
            {
                ...
                skills: {
                    ...
                    "Dagger Throw": {
                        ...
                        basePower: 1,
                        range: 12,
                        requiredWeaponType: [items_1.WeaponType.DAGGER],
                    },
                    Rush: {
                        name: "Rush",
                        reqPoints: 26,
            ...
            },
            {
                ...
                skills: {
                    Disarm: {
                        ...
                        isAOE: true,
                        aoeTargetMode: skills_1.AOETargetMode.GROUND_TARGETED,
                    },
                    "Tangled Legs": {
                        name: "Tangled Legs",
                        reqPoints: 16,
                    ...
                    "Plant Mine": {
                        ...
                        isAOE: true,
                        aoeRadius: 3,
                        damageType: skills_1.DamageType.MAGICAL,
                        damageSubType: skills_1.MagicalDamageSubType.FIRE,
                        basePower: 2,
                        consumableItem: "trap",
                        consumableItemQuantity: 1,
        ...
        skills: [
            {
                ...
                skills: {
                    ...
                    Regenerate: {
                        ...
                        cooldown: 5,
                        duration: 120,
                        description: "Every few seconds, restore a party member\'s HP based on SPI and class specialty",
                        buffEffectTable: {
                            healingOverTime: {
                                base: 15,
                                spiScale: 0.8,
                    ...
                    Restoration: {
                        ...
                        cooldown: 20,
                        duration: 120,
                        description: "Restore party HP over time based on SPI and class specialty",
                        buffEffectTable: {
                            healingOverTime: {
                                base: 15,
                                spiScale: 0.8,
            ...
            },
            {
                ...
                skills: {
                    "Pure Arrow": {
                        ...
                        damageType: skills_1.DamageType.MAGICAL,
                        damageSubType: skills_1.MagicalDamageSubType.HOLY,
                        basePower: 1,
                    },
        ...
        skills: [
            {
                ...
                skills: {
                    Hailstone: {
                        ...
                        damageSubType: skills_1.MagicalDamageSubType.ICE,
                        basePower: 0.1,
                    },
                    "Thunder Ball": {
                        name: "Thunder Ball",
                        ...
                        damageSubType: skills_1.MagicalDamageSubType.LIGHTNING,
                        basePower: 1.4,
                        isAOE: true,
                    },
                    "Ice Spear": {
                    ...
                    "Ice Tempest": {
                        ...
                        cooldown: 20,
                        duration: 0,
                        description: "Summon a storm of ice that damages and knocks back all enemies in range",
                        damageSubType: skills_1.MagicalDamageSubType.ICE,
                        isAOE: true,
                        aoeTargetMode: skills_1.AOETargetMode.GROUND_TARGETED,
                        aoeRadius: 8,
            ...
            },
            {
                ...
                skills: {
                    ...
                    "Psychic Blades": {
                        ...
                        duration: 0,
                        damageType: skills_1.DamageType.MAGICAL,
                        description: "Release 3 blades of energy that pierce enemies in a cone. Deals bonus damage based on enemy defense",
                        basePower: 2,
                        isAOE: true,
                        aoeTargetMode: skills_1.AOETargetMode.CONE,
                        coneAngle: 90,
                        coneRange: 8,
                        bladeWidth: 1.5,
                        bladeCount: 3,
                    ...
                    "Summon Plant": {
                        ...
                        cooldown: 60,
                        duration: 180,
                        description: "Summon an elemental plant turret that fires bolts at nearby enemies. Element matches weapon used when summoning.",
                        isAOE: true,
                        aoeTargetMode: skills_1.AOETargetMode.GROUND_TARGETED,
                        aoeRadius: 1,
            ...
            },
            {
                ...
                skills: {
                    ...
                    Pestilence: {
                        ...
                        aoeTargetMode: skills_1.AOETargetMode.GROUND_TARGETED,
                        damageType: skills_1.DamageType.MAGICAL,
                        damageSubType: skills_1.MagicalDamageSubType.POISON,
                        aoeRadius: 2,
                        pulseCount: 3,
                        pulseInterval: 1000,
                        hasDebuff: true,
                    ...
                    "Dark Frenzy": {
                        ...
                        cooldown: 10,
                        duration: 6,
                        description: "Pulses of darkness that deal both magical and physical damage to all enemies in range",
                        damageType: skills_1.DamageType.MAGICAL,
                        damageSubType: skills_1.MagicalDamageSubType.DARK,
                        basePower: 3,
                        isAOE: true,
...
exports.CATEGORY_ID_TO_KEY = {
    [skills_1.SkillCategoryId.MELEE]: 'melee',
    [skills_1.SkillCategoryId.TECHNIQUE]: 'technique',
    [skills_1.SkillCategoryId.PRAYER]: 'prayer',
    [skills_1.SkillCategoryId.MAGIC]: 'magic',
    [skills_1.SkillCategoryId.SPECIAL]: 'special',
};
...
exports.CATEGORY_LEVEL_SKILLS = {
    [skills_1.SkillCategoryId.MELEE]: {
        Slash: {
            name: "Slash",
            reqPoints: 3,
            mpCost: 10,
    ...
    [skills_1.SkillCategoryId.TECHNIQUE]: {
        Backstep: {
            name: "Backstep",
            reqPoints: 3,
            mpCost: 5,
    ...
    [skills_1.SkillCategoryId.PRAYER]: {
        Revidium: {
            name: "Revidium",
            reqPoints: 35,
            mpCost: 14,
        ...
        "Physical Barrier": {
            ...
            barrier: 'physical',
            skillType: skills_1.SkillType.BARRIER,
        },
        "Magic Barrier": {
            name: "Magic Barrier",
            reqPoints: 102,
    ...
    [skills_1.SkillCategoryId.MAGIC]: {},
    [skills_1.SkillCategoryId.SPECIAL]: {},
};
const SKILL_LOOKUP = (() => {
    const lookup = new Map();
    for (const category of Object.values(exports.CLASS_SKILL_DATA)) {
    ...
    for (const skills of Object.values(exports.CATEGORY_LEVEL_SKILLS)) {
