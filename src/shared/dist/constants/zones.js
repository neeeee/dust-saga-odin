...
exports.NATION_ZONE_MAP = exports.ZONE_DATABASE = exports.ZoneType = void 0;
exports.getZoneDefinition = getZoneDefinition;
exports.isZonePvpEnabled = isZonePvpEnabled;
var ZoneType;
(function (ZoneType) {
    ZoneType["SAFE"] = "safe";
    ZoneType["PVE"] = "pve";
    ZoneType["PVP"] = "pvp";
    ZoneType["NATION"] = "nation";
    ZoneType["WAR"] = "war";
    ZoneType["DUNGEON"] = "dungeon";
})(ZoneType || (exports.ZoneType = ZoneType = {}));
exports.ZONE_DATABASE = {
    'starter_zone': {
        id: 'starter_zone',
...
function getZoneDefinition(id) {
    return exports.ZONE_DATABASE[id];
}
function isZonePvpEnabled(zoneId) {
    return exports.ZONE_DATABASE[zoneId]?.isPvpEnabled === true;
}
exports.NATION_ZONE_MAP = {
