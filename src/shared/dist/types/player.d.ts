import { StatPoints } from './races';
import { JobId, SkillProficiencies, BaseClass } from './jobs';
import { StatBonusBreakdown, EffectiveStats } from './status';
...
export declare const ACCOUNT_ROLE_RANK: Record<AccountRole, number>;
export declare function roleAtLeast(actual: AccountRole | string | undefined | null, min: AccountRole): boolean;
...
export interface PlayerSession {
    ...
    inCutscene?: boolean;
    cutsceneReturnPosition?: {
        x: number;
        y: number;
        z: number;
    };
    cutsceneReturnRotation?: {
        x: number;
        y: number;
        z: number;
        w: number;
