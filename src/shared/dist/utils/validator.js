...
class Validator {
    static validatePosition(pos) {
        const MAX = game_1.GAME_CONFIG.MAX_POSITION;
    ...
    static validateMovement(input) {
        return (typeof input.speed === 'number' &&
            input.speed >= 0 &&
            input.speed <= game_1.GAME_CONFIG.PLAYER_SPEED * 2 &&
    ...
    static validateHealth(health, maxHealth) {
